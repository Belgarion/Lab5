...
import Lab5.CarWash.Event.ArriveEvent;
...
//		// ---
		...
		CarWashState state = new CarWashState(fast, slow, fastMin, fastMax, slowMin, slowMax, lambda, seed, maxQueueSize, stopTime);
...
//		state.setrandCarStream();

		queue.insert(new StartEvent());
//		queue.insert(new ArriveEvent(30.0));
