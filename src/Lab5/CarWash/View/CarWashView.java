...
public class CarWashView extends SimView {
	private static final Pattern typePattern = Pattern.compile(".*\\.(.*)Event");
	...
	public void print(Info i) {
		...
		if (i.lastEvent instanceof StartEvent) {
			...
			System.out.format("%10.2f      %-8s %2d    %2d      %2d       %2.2f       %2.2f         %2d        %2d\n",
						e.getTime(), eventType, e.getCar().getId(), i.emptyFast, i.emptySlow,
						i.totalIdleTime, i.totalQueueingTime, i.carsInQueue, i.numRejectedCars);
		} else {
			System.out.format("%10.2f      %-8s\n", i.lastEvent.getTime(), eventType);
		}
	}
}
